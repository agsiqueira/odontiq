...
const reachability: Array<[string, string[]]> = [
  ...
  ["What medical conditions do you have?", ["c1.diabetes", "c1.hypertension"]],
  ...
  ["Have you had a root canal or extraction on this tooth?", ["c1.prior-root-canal-unknown", "c1.prior-extraction-unknown"]],
];
